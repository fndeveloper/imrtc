...
<!-- =========== LINK START =================== -->
      <li  class="nav-item "><a  class="nav-link " aria-current="page"  href="Examinationsystemlogin.asp">Home</a></li>
<!-- =========== LINK END =================== -->
<!-- =========== LINK START =================== -->

<li  class="nav-item "><a  class="nav-link " aria-current="page"  href="goexam/goexamination.asp">Go Exam IMRTC </a></li>
<!-- =========== LINK END =================== -->
<!-- =========== LINK START =================== -->

<li  class="nav-item "><a  class="nav-link " aria-current="page"  href="PassedCandidates.asp">List Of Passed Candidates</a></li>
<!-- =========== LINK END =================== -->
